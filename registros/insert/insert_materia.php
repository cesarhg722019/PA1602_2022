...
//if( mysqli_connect_error())
 ...
 // mysqli_set_charset($connexion,"utf8");
  ...
  $instruccion_SQL = "INSERT INTO materia(descripcionmateria) VALUES('$_POST[descripcionmateria]')";
...
todo a su paso*/
   ...
   }  else
   {
       ...
       echo "<table><tr><td>descripcionmateria:'$_POST[descripcionmateria]'</td></tr>";
